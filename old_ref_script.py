...
class Tools(object):
    ...
    def plot_pdf(self, gpp, type_graph='hist', show=False, x_lim=None, hist_fitted_curve=True,
        ...
        if type_graph == 'hist':
            type_graph = False
        elif type_graph == 'lower':
            type_graph = True
        elif type_graph == 'higher':
            type_graph = -1
...
if __name__ == "__main__":
    ...
    plant.set_name('Feasibility Study 1')
    plant.set_location(lat=38.5, lon=28.1)
    plant.set_area(min=32.9, most_likely=33, max=33.1, mean=0, sd=0, pdf='T', doc=5)
    plant.set_thickness(min=200, most_likely=300, max=400, mean=0.0, sd=0.0, pdf='T')
    plant.set_volume(pdf=None)
    plant.set_reservoir_temp(min=200, most_likely=230, max=260, mean=0.0, sd=0.0, pdf='T')
    plant.set_abandon_temp(min=0.0, most_likely=100, max=0.0, mean=0.0, sd=0.0, pdf='C')
    plant.set_porosity(min=0.0, most_likely=0.04, max=0.0, mean=0.04, sd=0.02, pdf='L')
    plant.set_rock_specific_heat(min=0.85, most_likely=0.9, max=0.95, mean=0.0, sd=0.0,
                                 pdf='T')
    plant.set_fluid_specific_heat(min=0, most_likely=4.18, max=0, mean=0.0, sd=0.0, pdf='C')
    plant.set_rock_density(min=2650, most_likely=2750, max=2950, mean=0.0, sd=0.0, pdf='C')
    plant.set_fluid_density(min=822.78, most_likely=855.9, max=877.16, mean=0.0, sd=0.0, pdf='C')
    plant.set_recovery_factor(min=0.05, most_likely=0.07, max=0.09, mean=0.0, sd=0.0, pdf='C')
    plant.set_conversion_efficiency(min=0.154, most_likely=0.173, max=0.201, mean=0.0, sd=0.0,
                                    pdf='T')
    plant.set_plant_net_capacity_factor(min=0.8, most_likely=0.9, max=1.0, mean=0.0, sd=0.0,
                                        pdf='T')
    plant.set_lifespan(min=20, most_likely=25, max=30, mean=0.0, sd=0.0, pdf='C')

    plant = sim.calc_energy_potential(plant)
    tools.print_results(plant)
tools.plot_pdf(plant, type_graph='hist', show=True)
